...
const AboutUs = () => {
  return (
    <div className="container">
      ...
      quasi. Tempore assumenda voluptatibus, consequatur quisquam quod vel harum
      deleniti amet dolorum! Dolores doloribus provident quia enim? Porro fugit
      minus voluptate, soluta voluptatum a at temporibus iure expedita laborum.
      Eos aspernatur in sint officiis sunt tempora exercitationem tenetur,
      molestias earum perspiciatis sequi minus doloribus voluptatibus dicta
      suscipit! Vel distinctio commodi enim libero. Quae commodi accusamus autem
      itaque, illum amet sint quis architecto repudiandae labore ad consectetur,
      assumenda fugiat laudantium consequatur laboriosam temporibus ea tenetur
      dolore! Eius, corrupti. Deleniti maiores minus, dolorem, repellendus
      placeat reprehenderit earum illum vel reiciendis expedita id! Dolorem
      quasi nemo, aut, sequi accusantium libero a odit aspernatur labore iure
      optio fuga. Cupiditate, debitis et? Perferendis, similique! Optio non hic
